...
![](C:\Users\Administrator\Desktop\Ps\图层面板.png)
...
* **拾色器**
  ...
  ![](C:\Users\Administrator\Desktop\Ps\拾色器.png)
...
* **色相/饱和度**
  ...
  * 通过调节 色相 , 饱和度 来调节图片中的颜色 , 通过调节 明度 来调节图片中的明度
    ...
    ![](C:\Users\Administrator\Desktop\Ps\色相饱和度.png)

  * 可以在面板上方选择只改变图片中指定的色域 , 例如 红色 , 然后通过面板下方的影响色域滑块进行微调

    ![](C:\Users\Administrator\Desktop\Ps\设置调节色域.png)
...
* **色彩平衡**
  ...
  * 色彩平衡提供了对不同色调的针对性调节 , 使用色相盘中对立的三对颜色进行调节
    ...
    ![](C:\Users\Administrator\Desktop\Ps\色彩平衡盘.png)
...
* **黑白**
  ...
  * 黑白调节层的功能是将图片中的色相去除 , 也就是将所有颜色归到拾色器的 ***竖轴*** 上
    ...
    ![](C:\Users\Administrator\Desktop\Ps\黑白.png)
...
* **通道混合器( 最适合复杂的发丝抠图 ) **
  ...
  * 单颜色通道卡中 , 白色代表存在通道颜色 , 黑色代表不存在通道颜色 , 颜色越白 , 通道颜色越多
    ...
    ![](C:\Users\Administrator\Desktop\Ps\颜色通道.png)
  ...
  * 添加通道混合器来调整颜色通道
    ...
    ![](C:\Users\Administrator\Desktop\Ps\通道混合器.png)
...
>
> ![](C:\Users\Administrator\Desktop\Ps\颜色混合.png)

* **可选颜色 **

  * 在颜色选择中选择一种颜色 , 然后在下方基色调整中调整对当前选中颜色的混合 . 例如选择红色 , 在下方选择减去洋红 , 那么图片中红色区域会变为黄色

     ![](C:\Users\Administrator\Desktop\Ps\可选颜色.png)
